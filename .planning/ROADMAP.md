...
- [x] **Phase 36: 양식 필드 한 줄 최대 3개 레이아웃** - 양식 한 줄에 최대 3개 필드 배치 가능하도록 폼 렌더러/빌더 확장 (completed 2026-04-30)
...
| 36. 양식 필드 한 줄 최대 3개 레이아웃 | v1.2 | 4/4 | Complete   | 2026-04-30 |
...
- [x] 36-03-PLAN.md — Wave 3: FormPreview + DynamicCustomForm + DynamicCustomReadOnly grid 도입 (D-D1 backward compat invariant + D-19 hidden-field 처리 보존)
- [x] 36-04-PLAN.md — Wave 4: ko/admin.json 13 i18n 키 + ko/document.json ARIA 미러 + 통합 회귀 (tsc/vitest/vite build + dynamic class CSS 토큰 검증) + 7-gate HUMAN-UAT
**UI hint**: yes
