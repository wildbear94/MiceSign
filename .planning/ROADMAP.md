...
| 34. 양식 기안자 정보 헤더 자동 채움 | v1.2 | 0/6 | Not started | — |
...
**Plans:** 6 plans
Plans:
- [ ] 34-01-PLAN.md — Latent FE bug fix: DocumentDetailResponse flat-field alignment + L228 doc.drafter.name → doc.drafterName (Wave 1, D-G1/G2/G3)
- [ ] 34-02-PLAN.md — BE auth 확장: UserProfileDto + AuthService.buildUserProfile + AuthControllerTest (Wave 1, D-F1/F2)
- [ ] 34-03-PLAN.md — BE snapshot 캡처: DocumentService.submit drafterSnapshot 머지 + D-C7 롤백 + DocumentSubmitTest 3 신규 (Wave 1, D-A3/A4/C1~C7)
- [ ] 34-04-PLAN.md — FE foundation: DrafterInfoHeader 컴포넌트 + 3-case vitest + UserProfile + 8 i18n + templateRegistry props (Wave 2, D-D1~D5/D7/E2)
- [ ] 34-05-PLAN.md — FE 14-point integration: 7 Edit + 7 ReadOnly 헤더 삽입 + DocumentEditorPage/DocumentDetailPage props (Wave 3, D-D6/B1~B3)
