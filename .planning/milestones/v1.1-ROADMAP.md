...
- [x] **Phase 27: v1.1 검증 위생 보강 — 코드 FLAG + HUMAN UAT** - TemplateFormModal conditionalRules 리셋 누락 수정 + Phase 21~24 HUMAN-UAT 기록 완성 (gap closure) (completed 2026-04-14)
- [x] **Phase 28: v1.1 Nyquist validation 사후 보강** - Phase 21/22/24/25/26 VALIDATION.md 생성/보강 (gap closure, optional) (completed 2026-04-14)
