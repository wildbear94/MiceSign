...
class DocumentFormValidatorTest {
    ...
    void validateGeneral_valid_noException() {
        assertDoesNotThrow(() ->
            validator.validate("GENERAL", "<p>본문 내용입니다.</p>", null, null));
    }
    ...
    void validateGeneral_nullBody_throwsException() {
        assertThatThrownBy(() -> validator.validate("GENERAL", null, null, null))
            .isInstanceOf(BusinessException.class)
            .hasFieldOrPropertyWithValue("code", "DOC_INVALID_FORM_DATA");
    }
    ...
    void validateExpense_valid_noException() {
        String formData = """
            ...
            """;
        assertDoesNotThrow(() ->
            validator.validate("EXPENSE", null, formData, null));
    }
    ...
    void validateExpense_missingItems_throwsException() {
        String formData = """
            {"totalAmount":0}
            """;
        assertThatThrownBy(() -> validator.validate("EXPENSE", null, formData, null))
            .isInstanceOf(BusinessException.class)
            .hasFieldOrPropertyWithValue("code", "DOC_INVALID_FORM_DATA");
    }
    ...
    void validateExpense_nullFormData_throwsException() {
        assertThatThrownBy(() -> validator.validate("EXPENSE", null, null, null))
            .isInstanceOf(BusinessException.class)
            .hasFieldOrPropertyWithValue("code", "DOC_INVALID_FORM_DATA");
    }
    ...
    void validateExpense_invalidJson_throwsException() {
        assertThatThrownBy(() -> validator.validate("EXPENSE", null, "not json", null))
            .isInstanceOf(BusinessException.class)
            .hasFieldOrPropertyWithValue("code", "DOC_INVALID_FORM_DATA");
    }
    ...
    void validateLeave_valid_noException() {
        String formData = """
            ...
            """;
        assertDoesNotThrow(() ->
            validator.validate("LEAVE", null, formData, null));
    }
    ...
    void validateLeave_missingStartDate_throwsException() {
        String formData = """
            ...
            """;
        assertThatThrownBy(() -> validator.validate("LEAVE", null, formData, null))
            .isInstanceOf(BusinessException.class)
            .hasFieldOrPropertyWithValue("code", "DOC_INVALID_FORM_DATA");
    }
    ...
    void validateLeave_nullFormData_throwsException() {
        assertThatThrownBy(() -> validator.validate("LEAVE", null, null, null))
            .isInstanceOf(BusinessException.class)
            .hasFieldOrPropertyWithValue("code", "DOC_INVALID_FORM_DATA");
    }
    ...
    void validateUnknownTemplate_throwsException() {
        assertThatThrownBy(() -> validator.validate("UNKNOWN", null, null, null))
            .isInstanceOf(BusinessException.class)
