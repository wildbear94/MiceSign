...
export default function PurchaseForm({
  ...
  const defaultItems = [{ name: '', spec: '', quantity: 1, unitPrice: 0, amount: 0 }];
    ...
    <form id="document-form" onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div>
            ...
            >
              <option value="" disabled>
                {t('purchase.paymentMethodPlaceholder')}
              </option>
      ...
      <div className="overflow-x-auto">
        <table className="w-full border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
          ...
          <tfoot>
            <tr className="bg-gray-50 dark:bg-gray-800">
              <td colSpan={4} className="px-4 py-2 text-right font-semibold text-base text-gray-900 dark:text-gray-50">
                {t('purchase.total')}
              </td>
              <td className="px-4 py-2 text-right font-semibold text-base text-blue-600">
      ...
      {!readOnly && (
        <button
          type="button"
          onClick={() => append({ name: '', spec: '', quantity: 1, unitPrice: 0, amount: 0 })}
